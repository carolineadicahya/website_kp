        ...
        <div className="max-w-xl p-6 bg-white">
          ...
          <div>
            <Carousel
              ...
              transitionTime={500} // Set the transition time between slides
            >
              <div>
                <img src={gambar1} alt="Image 1" />
              </div>
              <div>
                <img src={gambar2} alt="Image 2" />
              </div>
              <div>
                <img src={gambar3} alt="Image 3" />
              </div>
              <div>
                <img src={gambar4} alt="Image 4" />
              </div>
              <div>
                <img src={gambar5} alt="Image 5" />
              </div>
            </Carousel>
          </div>
